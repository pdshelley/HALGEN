...
//    case uSIALT = "USI_ALT"
    ...
    case v0e = "V0E"
    case v1 = "V1"
                                // TODO: find a better name for this case and the other lpm?
...
//    case wDTOVERFLOW = "WDT_OVERFLOW"
                    case ADC_ADC = "ADC_ADC"
                    case ADC_READY = "ADC_READY"
                    case ANA_COMP0 = "ANA_COMP0"
                    case ANA_COMP1 = "ANA_COMP1"
                    case EEPROM_Ready = "EEPROM_Ready"
                    case ERROR = "ERROR"
                    case EXT_INT0 = "EXT_INT0"
                    case FAULT_PROTECTION = "FAULT_PROTECTION"
                    case IO_PINS = "IO_PINS"
                    case PCINT = "PCINT"
                    case PCINT_A = "PCINT_A"
                    case PCINT_B = "PCINT_B"
                    case PCINT_D = "PCINT_D"
                    case QTRIP = "QTRIP"
                    case SAMPRDY = "SAMPRDY"
                    case SPI = "SPI"
                    case TIM0_CAPT = "TIM0_CAPT"
                    case TIM1_CAPT = "TIM1_CAPT"
                    case TIM1_COMPA = "TIM1_COMPA"
                    case TIM1_COMPB = "TIM1_COMPB"
                    case TIMER0_CAPT = "TIMER0_CAPT"
                    case TIMER0_OVF0 = "TIMER0_OVF0"
                    case TIMER1_CMPA = "TIMER1_CMPA"
                    case TIMER1_CMPB = "TIMER1_CMPB"
                    case TIMER1_COMP = "TIMER1_COMP"
                    case TIMER1_COMPD = "TIMER1_COMPD"
                    case TIMER1_OVF1 = "TIMER1_OVF1"
                    case TIMER2_CAPT = "TIMER2_CAPT"
                    case TRIG = "TRIG"
                    case TWI_SLAVE = "TWI_SLAVE"
                    case USART0_DRE = "USART0_DRE"
                    case USART1_DRE = "USART1_DRE"
                    case USART_DRE = "USART_DRE"
                    case USART_RXS = "USART_RXS"
                    case USI_OVF = "USI_OVF"
                    case USI_STR = "USI_STR"
                    case USI_STRT = "USI_STRT"
                    case WDT_OVERFLOW = "WDT_OVERFLOW"
}
...
//    case watchdogTimerOverflow = "Watchdog Timer Overflow"
                    ...
                    case timerCounter1CompareMatchA1 = " Timer/Counter1 Compare Match A"
                    case timerCounter1CompareMatchB1 = " Timer/Counter1 Compare Match B"
                    case adcConversionReady = "ADC Conversion Ready"
                    case adcConversionComplete1 = "ADC Conversion complete"
                    case adcConversionReady2 = "ADC Conversion ready"
                    case analogComparator4 = "Analog comparator"
                    case conversionComplete = "Conversion Complete"
                    case externalPinPowerOnResetBrownOutResetWatchdogReset = "External Pin, Power-on Reset, Brown-out Reset,Watchdog Reset"
                    ...
                    case touchSensing = "Touch Sensing"
                    case twoWireInterface = "Two-Wire Interface"
                    case usartDataRegisterEmpty1 = "USART Data register empty"
                    case usartRxComplete1 = "USART RX Complete"
                    case usartRxStart = "USART RX Start"
                    case usartStart = "USART, Start"
                    case usart0Start = "USART0, Start"
                    case usart1Start = "USART1, Start"
                    case usiCounterOverflow = "USI Counter Overflow"
                    case usiStart = "USI START"
                    case usiStart2 = "USI Start" // Renamed to avoid collision if necessary, otherwise usiStart
                    case usiStartConditionDetection = "USI Start Condition Detection"
                    case vccVoltageLevelMonitor = "Vcc Voltage Level Monitor"
                    case watchdogTimeOut2 = "Watchdog Time-Out"
                    case watchdogTimerOverflow = "Watchdog Timer Overflow"
