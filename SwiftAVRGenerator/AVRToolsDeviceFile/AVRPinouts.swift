...
struct AVRPinouts: Codable {
    ...
    struct Pinout: Codable {
        ...
        struct Caption: Codable, CaseIterable {
            ...
            static let TQFPVQFN44 = Caption(value: "TQFP_VQFN_44")
            ...
            init(from decoder: Decoder) throws {
                ...
                if let p = Self.allCases.first(where: { $0.rawValue == string }) {
                    ...
                    throw DecodingError.dataCorruptedError(in: container, debugDescription: "Unknown value '\(string)'") // TODO: Figure out how to put this variable in the multi-line string.
                }
            }
