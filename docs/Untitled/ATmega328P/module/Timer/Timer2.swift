...
public struct Timer2: Timer8Bit, AsyncTimer {
    ...
    public static var waveformGenerationMode: Timer8Bit.WaveformGenerationMode {
        ...
        set {
            controlRegisterB = (controlRegisterB & ~0b00001000) | (((newValue.rawValue & 0b00000001) << UInt8(3)) & 0b00001000)
            controlRegisterA = (controlRegisterA & ~0b00000011) | (((newValue.rawValue & 0b00000110) >> UInt8(1)) & 0b00000011)
        }
    }
    /// TCCR2B – Timer/Counter2
    /// ```
    /// --------------------------------------------------------------------------------
    /// | Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    /// --------------------------------------------------------------------------------
