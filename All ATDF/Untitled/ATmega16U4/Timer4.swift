...
public struct Timer4: Timer10Bit {
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0xBE)       | TC47  | TC46  | TC45  | TC44  | TC43  | TC42  | TC41  | TC40  |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |       |       |       |       |       |       |       |       |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ...
    public static var :  {
        get {
            let mode = (timerCounter & 0b00000111) >> UInt8(0)
            return .init(rawValue: mode) ??
        }
        set {
            timerCounter |= (newValue.rawValue & 0b00000111) << UInt8(0)
        }
    }
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0xCF)       |OCR4A7 |OCR4A6 |OCR4A5 |OCR4A4 |OCR4A3 |OCR4A2 |OCR4A1 |OCR4A0 |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |       |       |       |       |       |       |       |       |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0xD0)       |OCR4B7 |OCR4B6 |OCR4B5 |OCR4B4 |OCR4B3 |OCR4B2 |OCR4B1 |OCR4B0 |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |       |       |       |       |       |       |       |       |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0xD1)       |OCR4C7 |OCR4C6 |OCR4C5 |OCR4C4 |OCR4C3 |OCR4C2 |OCR4C1 |OCR4C0 |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |       |       |       |       |       |       |       |       |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ...
    public static var :  {
        get {
            let mode = (timerCounterOutputCompareRegisterC & 0b11111111) >> UInt8(0)
            return .init(rawValue: mode) ??
        }
        set {
            timerCounterOutputCompareRegisterC |= (newValue.rawValue & 0b11111111) << UInt8(0)
        }
    }
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0xD2)       |OCR4D7 |OCR4D6 |OCR4D5 |OCR4D4 |OCR4D3 |OCR4D2 |OCR4D1 |OCR4D0 |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |       |       |       |       |       |       |       |       |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ...
    public static var :  {
        get {
            let mode = (timerCounterOutputCompareRegisterD & 0b11111111) >> UInt8(0)
            return .init(rawValue: mode) ??
        }
        set {
            timerCounterOutputCompareRegisterD |= (newValue.rawValue & 0b11111111) << UInt8(0)
        }
    }
    ...
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |       |  R/W  |  R/W  |   R   |   R   |  R/W  |   R   |   R   |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ///--------------------------------------------------------------------------------
    ///```
