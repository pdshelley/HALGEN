...
public struct Timer3: Timer16Bit, HasExternalClock {
    ...
    /// WGM4 – Waveform Generation Mode bits 
    ///
    ...
    public static var waveformGenerationMode: Timer16Bit.WaveformGenerationMode {
        get {
            let mode = ((controlRegisterA & 0b00000011) >> 1) | (timerCounterControlRegisterD & 0b00000011)
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0x94)       |TCNT37 |TCNT36 |TCNT35 |TCNT34 |TCNT33 |TCNT32 |TCNT31 |TCNT30 |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   0   |   0   |   0   |   0   |   0   |   0   |   0   |   0   |
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0x98)       |OCR3A7 |OCR3A6 |OCR3A5 |OCR3A4 |OCR3A3 |OCR3A2 |OCR3A1 |OCR3A0 |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   0   |   0   |   0   |   0   |   0   |   0   |   0   |   0   |
    ...
    /// OCR3A – Timer/Counter3 Output Compare A bits 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0x9A)       |OCR3B7 |OCR3B6 |OCR3B5 |OCR3B4 |OCR3B3 |OCR3B2 |OCR3B1 |OCR3B0 |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   0   |   0   |   0   |   0   |   0   |   0   |   0   |   0   |
    ...
    /// OCR3B – Timer/Counter3 Output Compare B bits 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0x9C)       |OCR3C7 |OCR3C6 |OCR3C5 |OCR3C4 |OCR3C3 |OCR3C2 |OCR3C1 |OCR3C0 |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   0   |   0   |   0   |   0   |   0   |   0   |   0   |   0   |
    ...
    /// OCR3C – Timer/Counter3 Output Compare C bits 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
            let mode = (timerCounterOutputCompareRegisterCBytes & 0b11111111) >> UInt8(0)
            return .init(rawValue: mode) ??
        }
        set {
            timerCounterOutputCompareRegisterCBytes |= (newValue.rawValue & 0b11111111) << UInt8(0)
        }
    }
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0x96)       | ICR37 | ICR36 | ICR35 | ICR34 | ICR33 | ICR32 | ICR31 | ICR30 |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   0   |   0   |   0   |   0   |   0   |   0   |   0   |   0   |
    ...
    /// ICR3 – Timer/Counter3 Input Capture bits 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
    ...
    /// OCR1A – Timer/Counter1 Output Compare A bits 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
    ...
    /// OCR1B – Timer/Counter1 Output Compare B bits 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0x8C)       |OCR1C7 |OCR1C6 |OCR1C5 |OCR1C4 |OCR1C3 |OCR1C2 |OCR1C1 |OCR1C0 |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   0   |   0   |   0   |   0   |   0   |   0   |   0   |   0   |
    ...
    /// OCR1C – Timer/Counter1 Output Compare C bits 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
