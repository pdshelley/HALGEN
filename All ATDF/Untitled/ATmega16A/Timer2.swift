...
public struct Timer2: Timer8Bit, AsyncTimer {
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0x44)       |TCNT27 |TCNT26 |TCNT25 |TCNT24 |TCNT23 |TCNT22 |TCNT21 |TCNT20 |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   0   |   0   |   0   |   0   |   0   |   0   |   0   |   0   |
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0x43)       | OCR27 | OCR26 | OCR25 | OCR24 | OCR23 | OCR22 | OCR21 | OCR20 |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ///--------------------------------------------------------------------------------
    ///| InitialValue |   0   |   0   |   0   |   0   |   0   |   0   |   0   |   0   |
    ...
    /// OCR2 – Timer/Counter2 Output Compare bits 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
            let mode = (timerCounterOutputCompareRegister & 0b11111111) >> UInt8(0)
            return .init(rawValue: mode) ??
        }
        set {
            timerCounterOutputCompareRegister |= (newValue.rawValue & 0b11111111) << UInt8(0)
        }
    }
