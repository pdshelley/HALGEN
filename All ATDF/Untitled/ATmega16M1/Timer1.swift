...
public struct Timer1: Timer16Bit, HasExternalClock {
    ...
    /// OCR1A – Timer/Counter1 Output Compare bits 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
    ...
    /// OCR1B – Timer/Counter1 Output Compare bits 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
    ...
    /// ICR1 – Timer/Counter1 Input Capture Register
    ///```
    ///--------------------------------------------------------------------------------
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ...
    @inlinable
    @inline(__always)
    public static var timerCounterInputCaptureRegister: UInt16 {
        get {
    ...
    public static var :  {
        get {
            let mode = (timerCounterInputCaptureRegister & 0b11111111) >> UInt8(0)
            return .init(rawValue: mode) ??
        }
        set {
            timerCounterInputCaptureRegister |= (newValue.rawValue & 0b11111111) << UInt8(0)
        }
    }
    ...
    /// ICPSEL1 – Timer/Counter1 Input Capture Selection 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
            let mode = (generalControlRegister & 0b01000000) >> UInt8(6)
            return .init(rawValue: mode) ??
        }
        set {
            generalControlRegister |= (newValue.rawValue & 0b00000001) << UInt8(6)
        }
    }
    /// PSRSYNC – Timer/Counter Prescaler Reset 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
