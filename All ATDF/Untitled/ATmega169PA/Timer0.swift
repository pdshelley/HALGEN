...
public struct Timer0: Timer8Bit, HasExternalClock {
    ...
    ///| Bit          |   7   |   6   |   5   |   4   |   3   |   2   |   1   |   0   |
    ///--------------------------------------------------------------------------------
    ///| (0x44)       | FOC0A | WGM00 |COM0A1 |COM0A0 | WGM01 | CS02  | CS01  | CS00  |
    ///--------------------------------------------------------------------------------
    ///| Read/Write   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |   ?   |
    ///--------------------------------------------------------------------------------
    ...
    /// COM0A – Compare Match Output Modes 
    ///
    ...
    public static var waveformGenerationMode: Timer8Bit.WaveformGenerationMode {
        get {
            let mode = ((controlRegisterA & 0b00001000) >> 1) | (controlRegisterA & 0b01000000)
    ...
    /// OCR0A – Timer/Counter0 Output Compare A 
    @inlinable
    @inline(__always)
    public static var :  {
        get {
