...
public struct GPIO { // TODO: I think I want to rename this struct to AVR5 or something similar. This will probably be the HAL layer for the avr5 core and I'll make a wrapper with a common HAL API that wraps this.
    ...
    public enum PORTE: Port {
        ...
        @inlinable
        @inline(__always)
        public static var dataRegister: UInt8 { get { _volatileRegisterReadUInt8(0x27) } set { _volatileRegisterWriteUInt8(0x27, newValue) } }
        ...
        @inlinable
        @inline(__always)
        public static var dataDirection: UInt8 { get { _volatileRegisterReadUInt8(0x26) } set { _volatileRegisterWriteUInt8(0x26, newValue) } }
        ...
        @inlinable
        @inline(__always)
        public static var inputAddress: UInt8 { get { _volatileRegisterReadUInt8(0x25) } set { _volatileRegisterWriteUInt8(0x25, newValue) } }
    }
